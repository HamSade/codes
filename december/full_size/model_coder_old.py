...
coder_depths = [64, 128, 256, 512]
disc_depths = [64, 128, 256, 512]

compressed_row = 256 // 16
compressed_col = 64 // 16 

z_dim = int(32 * compressed_row * compressed_col)  # 4 Kbs
...
#        self.z = tf.random_uniform([self.batch_size, self.z_dim], minval=-1.0, maxval=1.0)
    ...
    def __call__(self, X, noise_std, training = 1.0):
        ...
        enc_output = self.enc(X, training = training_bool)
