...
class SEGAN(Model):
    ...
    def __init__(self, sess, args, devices, infer=False, name='SEGAN'):
        ...
        # Define D fmaps
        self.d_num_fmaps = [16, 32, 32, 64, 64, 128, 128, 256, 256, 512, 1024]  # same as depths?
        ...
        # AE or dwave? This is why we have generator and encoder being different?
        if args.g_type == 'ae':
...
##########  Cost definition 
        ...
        g_adv_loss = tf.reduce_mean(tf.squared_difference(d_fk_logits, 1.)) #d_fk == D(G(x_c))
