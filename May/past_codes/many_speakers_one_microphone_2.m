...
main_path = '/vol/grid-solar/sgeusers/hsadeghi/PDA/PDAs/';
dest_path='/vol/grid-solar/sgeusers/hsadeghi/data/';
...
for k=1:num_folders
    ...
    for i=1:num_sums_to_concat
        ...
        display ([k, i], ['folder index', '   iteration'])
%         display(i, 'iteration')
    ...
    %% Saving
    save_path = [dest_path, 'com_concat_signal_', num2str(k-1), '.mat'];
