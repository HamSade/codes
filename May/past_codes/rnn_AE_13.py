...
# -*- coding: utf-8 -*-
"""
Created on Wed May  3 13:33:40 2017

@author: hsadeghi

In this version I added preemphasis and demepohasis
"""
...
from data_loader import pre_emph, data_loader
...
def rnn(input_dim=512,
        ...
        num_steps    = 4,
        dropout_p = 1.,
        display_step = 100, scope='rnn_self', emphasis='False'):
    ...
    with tf.variable_scope(scope):
        ...
        std_weight=0.01; #( 2.0 / max( [full_width, rnn_width] ))**0.5;
        std_bias=0.001;
        ...
        for epoch in range(training_epochs):
            ...
            for file_idx in range(10):
                ...
                for  i in range(n_batch):
                    ...
                    batch_xs= training_data[ start_ind* batch_size : (start_ind + 1)* batch_size, :];  # 50% overlap 
