...
# -*- coding: utf-8 -*-
"""
Created on Tue May  2 23:42:02 2017

@author: hsadeghi


Diffrent file number are over different cuda machine with diff learning rates and rnn sizes

"""
import scipy.io as si 

#import rnn_AE_13 as script
                            ...
                            for i8 in range(len(params.dropout_p)):
                                ...
                                try:
                                    a,b = rnn( input_dim        = params.input_dim          [i1],
                                                ...
                                                binary_width     = int(params.input_dim[i1]/params.num_steps[i7]*2),
...
#                                    save_name = "/home/hsadeghi/Dropbox/May/opt_rnn_results/config_cuda_1_{}_{}.mat".format(counter, test_error)
#                                    si.savemat(save_name, results);
                                    
                                    save_name = "/home/hsadeghi/Dropbox/May/opt_rnn_results/config_cuda_1_{}_{}.txt".format(counter, test_error) 
