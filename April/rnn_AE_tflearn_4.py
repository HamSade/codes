...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  6 11:03:32 2017
...
class codec():
    ...
    def encode(self, x, init_state):
        ...
        self.enc_full = full_layer (x, full_width)
        
        self.enc_full = batch_norm(self.enc_full)
        self.enc_full = tf.reshape(self.enc_full, [-1,1,full_width])
            
        self.enc_rnn_output, self.rnn_state_1 = rnn_layer(self.enc_full, init_state[0], rnn_width)
     
        self.enc_rnn_output, self.enc_rnn_state_2 = rnn_layer(self.enc_rnn_output, init_state[1],
                                                              rnn_width)
    ...
    #    print (rnn_output.get_shape()[1].value)  #512
        ...
        self.full_middle= full_layer (self.enc_rnn_output, binary_width)
        
        self.enc_rnn_state = [self.rnn_state_1, self.enc_rnn_state_2]
    ...
    def decode(self, x, init_state):
        ...
        self.dec_rnn_output, self.dec_rnn_state_1 = rnn_layer(x, init_state[0], rnn_width)
        
        self.dec_rnn_output, self.dec_rnn_state_2 = rnn_layer(self.dec_rnn_output, init_state[1],
                                                              rnn_width)
    ...
    #    rnn_output = tf.transpose(rnn_output, [1,0, rnn_width])
        ...
        self.dec_full = full_layer (self.dec_rnn_output, full_width)
        
        self.full_out = full_layer (self.dec_full, input_dim)
        
        self.dec_rnn_state = [self.dec_rnn_state_1, self.dec_rnn_state_2]
