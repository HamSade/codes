...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 24 15:07:21 2017

@author: hsadeghi

# Batch normalization was checked to share variables
...
path_name = '/home/hsadeghi/Dropbox/April/Data/'
...
for epoch in range(training_epochs):
    ...
    #        batch_xs= tf.reshape(batch_xs, (batch_size,1,input_dim) )       
            _, c = sess.run([optimizer, cost], feed_dict={X: batch_xs, mode:0.0, learning_rate: learning_rate_new})
