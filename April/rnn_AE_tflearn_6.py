...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  7 11:06:31 2017
...
def full_layer(x, width):
        ...
        output = tflearn.fully_connected(x, width, reuse=True, scope=full_scope)
...
#%%
def rnn_layer(x, init_state, width, scope_rnn):
...
#        with tf.variable_scope('enc_full') as sef1:
        o = full_layer (x, full_width, sef1)
        
#        o = batch_norm(o)
        o = tf.reshape(o, [-1,1,full_width])
            
        with tf.variable_scope('enc_rnn_1') as ser1:
            
            o, enc_rnn_state_1 = rnn_layer(o, init_state[0], rnn_width, ser1)
     
        with tf.variable_scope('enc_rnn_2') as ser2:
            
            o, enc_rnn_state_2 = rnn_layer(o, init_state[1],rnn_width, ser2)
    ...
    #    print (rnn_output.get_shape()[1].value)  #512
        ...
        with tf.variable_scope('enc_middle') as seb:
            o= full_layer (o, binary_width, seb)
...
#        x =  batch_norm(x)
        ...
        with tf.variable_scope('dec_rnn_1') as sdr1:
            
            o, dec_rnn_state_1 = rnn_layer(x, init_state[0], rnn_width, sdr1)
            
        with tf.variable_scope('dec_rnn_2') as sdr2:
        
            o, dec_rnn_state_2 = rnn_layer(o, init_state[1], rnn_width, sdr2)
             
    #    rnn_output = tf.transpose(rnn_output, [1,0, rnn_width])
    
        o = tf.reshape(o, [-1, rnn_width])                                                  
       
        with tf.variable_scope('dec_full') as sdf:
            o = full_layer(o, full_width, sdf)
        
        with tf.variable_scope('dec_out') as sdo:
            o = full_layer (o, input_dim, sdo)
