...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr  8 18:57:30 2017
...
# L1 cost
#cost = tf.reduce_mean( tf.abs(y_true - y_pred[str(num_quantization_steps)] ) )
...
y_pred_test, y_true_test, test_error, codes = sess.run([y_pred[str(num_quantization_steps)], y_true, cost, codes],
